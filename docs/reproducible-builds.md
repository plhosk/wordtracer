...
It executes those commands inside a Debian forky container while mounting the CI Android SDK and running `fdroid` from the current `master` source archive.
